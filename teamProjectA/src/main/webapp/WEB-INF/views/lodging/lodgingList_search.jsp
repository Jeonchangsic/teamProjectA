...
<%
	List<LodgingVO> listSearch = (List<LodgingVO>)request.getAttribute("listSearch");
    ...
    <section id="body_inner" class="fixedclear">
        <section id="inner" class="fixedclear" >
         ...
         <div id="inner2" >
           ...
           <h2>인기추천</h2 >
            <c:forEach var="vo3" items="${listSearch}" varStatus="status">
          			...
          			<c:if test="${vo3.lidx == vo2.lidx && vo2.rnum > 0}">
			            <a href="<%=request.getContextPath() %>/lodging/lodgingView.do?lidx=${vo2.lidx}">
			                <div class="imgbor">
			                	...
			                	<img src="<%=request.getContextPath()%>/resources/images/lodging_images/${vo3.limagename}"> 
			                </div>
			            </a>
