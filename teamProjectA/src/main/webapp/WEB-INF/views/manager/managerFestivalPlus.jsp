...
<head>
    ...
    <title>저긴어때</title>
    <link href="<%=request.getContextPath()%>/resources/css/manager_css/managerFestivalPlus.css" rel="stylesheet"/>
    <!-- 파비콘 -->
    <link href="<%=request.getContextPath() %>/resources/images/login_images/logo2.svg" rel="shortcut icon">
    <!---- jQuery ---->
     <script src="https://code.jquery.com/jquery-3.6.1.min.js"></script>
     
     <!-- 축제설명 content영역 글자 제한 -->
     <script>
...
<body>
    <header>
        <h2 class="font_Style">페스티발 추가</h2>
    </header>
    <div id="headLine"></div>
                <!--end header-->
    <form action="festivalPlus.do" method="POST">
	    <table>
	    	<tr>
	    		...
	    		<td>
	    			<input type="text" name="ftName" maxlength="10"  placeholder="10자 이내로 작성해주세요." required/>
	    		</td>
	    	</tr>
	    	<tr>
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<input type="text" name="ftSubContent" maxlength="15"  placeholder="15자 이내로 작성해주세요." required/>
	    		</td>
	    	</tr>
	    	<tr>
	    		<td id="middle" class="font_Style font_StyleBold">축제설명</td>
	    		<td id="textarea_Style">
	    			<textarea id="info" cols="30" rows="10" name="ftMainContent" maxlength="300"  placeholder="300자 이내로 작성해주세요." required></textarea>
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<input type="text" name="ftLink" maxlength="400" placeholder="예: http://www.chunhyang.org" required/>
	    		</td>
	    	</tr>
	    	<tr>
	    		<td class="font_Style font_StyleBold">지도좌표</td>
	    		<td>
	    			<input id="map_Input" type="text" name="ftLatitude" placeholder="위도를 입력하세요." maxlength="480" required/>
	    			<input id="map_Input2" type="text" name="ftLongitude" placeholder="경도를 입력하세요." maxlength="480" required/>
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<input id="file_Input" type="file" name="ftImgName" maxlength="50" required/>
	    		</td>
	    	</tr>
	    </table>
    <div id="btn_Area">
