...
var positions = [
{
	content: '<div style="padding:5px; width: 230px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">늘품호텔</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 230px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">전주 한옥호텔 <br> 왕의지밀</a>'+
				'</div>'+
			'</div>',
...
},
{
    content:'<div style="padding:5px; width: 230px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">쏠비치 진도 호텔</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 230px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">그랜드 하얏트 제주</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 240px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">오션 스위츠 제주</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 240px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">전주 메이드-<Br>HOTEL MADE</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 200px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">군산 호텔 PM</a>'+
				'</div>'+
			'</div>',
...
},
{
    content:'<div style="padding:5px; width: 220px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">익산 호텔 G7</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 270px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">제주 노블레스 관광호텔</a>'+
				'</div>'+
			'</div>',
...
},
{
    content:'<div style="padding:5px; width: 220px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">제주 퓨어 스테이</a>'+
				'</div>'+
			'</div>',
...
{		//여기부터
    content:'<div style="padding:5px; width: 200px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">해운대 마린케이<br>풀빌라펜션</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 230px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">부산 뷰먼드풀빌라</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 250px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">부산 타이드어웨이<br> 풀빌라</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 200px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">해운대 송정 오셔너스</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 230px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">부산 씨앤트리풀빌라</a>'+
				'</div>'+
			'</div>',
    latlng: new kakao.maps.LatLng(35.177038946625096, 129.19686768887712)
},
{
    content: '<div style="padding:5px; width: 200px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">홍대 롬바드 게스트하우스</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 230px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">연남 소풍 더 어반<br> 게스트하우스</a>'+
				'</div>'+
			'</div>',
    latlng: new kakao.maps.LatLng(37.554209186747315, 126.9158032511722 )
},
{
    content: '<div style="padding:5px; width: 230px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">야코리아 호스텔 <br>동대문점</a>'+
				'</div>'+
			'</div>',
...
},
{
    content:'<div style="padding:5px; width: 250px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">이태원 G 게스트하우스</a>'+
				'</div>'+
			'</div>',
...
},
{
    content: '<div style="padding:5px; width: 290px">'+
				...
				'<div id="modalR">'+
					...
					'<a href="http://localhost:8080/A/lodging/lodgingView.do?lidx=261" target="_blank">서울숲스테이(Seoul Forest)</a>'+
				'</div>'+
			'</div>',
